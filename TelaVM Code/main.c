...
void addVariable(ActivationRecord* ar, DataStack* data, char* name, char* type)
{
    ...
    switch (type[0])
    {
        case 'i': pushInt(data, 0); break;
        case 'f': pushFloat(data, 0); break;
        case 'c': pushChar(data, '\0'); break;
        case 's': pushString(data); break;
    }
}
